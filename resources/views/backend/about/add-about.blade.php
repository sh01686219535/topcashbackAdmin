                        ...
                        <div class="col-lg-8">
                            <form action="{{ route('store.about') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="about_itle" name="about_itle" placeholder="Enter About Title" class="form-control my-2">
                                </div>
                                <div class="form-group">
                                    <label for="about_image"><strong>Image</strong></label>
                                    <input type="file" id="about_image" name="about_image" class="form-control my-2">
                                    <img id="show_img" src="{{asset('admin')}}/assets/img/avatars/noImage.jpg" style="width:150px;height:150px; border-radius:15px;" alt="">
                                </div>
                                <div class="form-group">
                                    <label for="image_description"><strong>Image Description</strong></label>
                                    <textarea name="image_description" id="editor" class="form-control my-2"></textarea>
                                </div>
