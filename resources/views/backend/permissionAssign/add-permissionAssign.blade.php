        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                       <div class="col-lg-6">
                        <form  action="{{ route('accessControl') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="col-9 rol-{{ $i }}-management-checkbox">
                                            ...
                                            @foreach($subModule->permission as $permissions)
                                                <div class="form-check">
                                                    ...
                                                    <input type="checkbox" name="permission_id[]" id="exam-check{{$permissions->id}}" class="form-check-input" value="{{$permissions->id}}">
                                                </div>
                                                @php
                                                    $j++;
                                                @endphp
