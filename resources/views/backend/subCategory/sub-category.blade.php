			...
			<!-- <div class="card mb-2">
                <div class="card-head mx-5 my-3 customer-card">
                    <a href="" class="btn btn-primary" title="Add Category" data-bs-toggle="modal"
                        data-bs-target="#subCategoryModal"><i class="fa-solid fa-plus"></i> Add Sub Category</a>
                    <div class="search">
			...
			<div class="card">
				<div class="card-body">
					<div class="customer-card mb-3" style="margin-top:-10px;">
						<div class="area-h3">
							<h2>Sub Category Table</h2> </div>
						<div class="print"> <a href="{{route('csv.customer')}}" class="btn btn-primary pdf">CSV</a> 
					...
					<div class="btn-customer" style="margin-top:10px;"> 
                        <a href="" class="btn btn-primary" title="Add Category" data-bs-toggle="modal" data-bs-target="#subCategoryModal"><i class="fa-solid fa-plus"></i> Add Sub Category</a> </div>
                    </div>
                        <table class="table table-hover table-borderd" id="example">
							...
							<tbody> @php $i = 1 @endphp @foreach($subCategory as $subCategories)
								<tr>
									<td>{{$i++}}</td>
                                    ...
                                    </div> --><a href="{{route('edit.subCategory',$subCategories->id)}}" title="Edit" class="btn btn-primary"><i class="fa-regular fa-pen-to-square"></i></a> <a href="{{route('delete.subCategory',$subCategories->id)}}" title="Delete" class="btn btn-danger" id="delete"><i class="fa-solid fa-trash"></i></a> </td>
								</tr> 
                                @endforeach 
                            </tbody>
						</table>
