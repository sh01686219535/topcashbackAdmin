                        ...
                        <div class="col-lg-8">
                            <form action="{{route('store.slider')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="position"><strong>Text On Slider</strong></label>
                                    <input type="text" id="position" name="position" placeholder="Enter Text For Slider" class="form-control my-2">
                                </div>
                                <div class="form-group">
