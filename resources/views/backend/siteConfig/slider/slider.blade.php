            ...
            <div class="col-lg-12">
                <!-- <div class="card mb-2">
                    <div class="card-head mx-5 my-3 customer-card">
                        <a href="{{route('add.slider')}}" class="btn btn-primary" title="Add Category" ><i class="fa-solid fa-plus"></i> Add Slider</a>
                        <div class="search">
                             ...
                             @foreach($slider as $sliders)
                                 <tr>
                                    <td>{{$i++}}</td>
                                     ...
                                     <td>
                                         <img src="{{asset('admin/assets/slider-image/'.$sliders->image)}}" class="slideImg" alt="">
                                     </td>
                                     <td>
                                         <a href="{{route('edit.slider',$sliders->id)}}" class="btn btn-primary" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
                                         <a href="{{route('delete.slider',$sliders->id)}}" class="btn btn-danger" id="delete"><i class="fa-solid fa-trash"></i></a>
                                     </td>
                                </tr>
                                 @endforeach
                            </tbody>
