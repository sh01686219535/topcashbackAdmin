                        ...
                        <div class="col-lg-8">
                            <form action="{{ route('update.menu') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="footer_menu" value="{{$footerMenu->footer_menu}}" name="footer_menu" placeholder="Enter Footer Menu" class="form-control my-2">
                                </div>
