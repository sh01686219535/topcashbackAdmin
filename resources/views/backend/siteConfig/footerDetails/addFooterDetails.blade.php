        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-lg-8">
                            <form action="{{ route('storeFooter_details') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="footermenu_id" id="footer_menu">
                                        ...
                                        @foreach($footer_menu as $menu)
                                            <option value="{{ $menu->id }}">{{ $menu->footer_menu }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" placeholder="Enter Title" class="form-control my-2">
                                </div>
                                <div class="form-group">
                                    <label for="slug"><strong>Slug</strong></label>
                                    <input type="text" id="slug" name="slug" placeholder="Enter Slug" class="form-control my-2">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="editor" name="description"  class="form-control my-2"></textarea>
                                </div>
